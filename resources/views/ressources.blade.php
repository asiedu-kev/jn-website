...
@section('content')
    <section class="mt-header wb-pb-7">
        <div class="container-title d-flex justify-content-center align-items-center">
            ...
            <div class="col-md-10 col-12 text-center d-flex align-items-center">
                <div class="col text-start">
                    <h1 class="wb-h3 mb-4 d-none d-md-inline">Coaching entrepreneuriat et e-commerce</h1>
                    <h1 class="wb-h3 mb-4 d-inline d-md-none">Coaching entrepreneur <br> iat et e-commerce</h1>

                    <p class="fs-24">Passe un nouveau cap ta vie et dans tes business</p>
                ...
                <div class="col d-none d-md-block">
                    <img src="" alt="" class="training-hero-img">
                </div>
        ...
        <div class="col-12 d-flex justify-content-center px-3 py-3 mt-3 d-block d-md-none">
            <img src="" alt="" class="training-hero-img">
        </div>
    </section>
    ...
    <section>
        <div class="container-wb wb-py-7">
            ...
            <div class="d-flex justify-content-center flex-column flex-md-row align-items-center mt-5">
                ...
                <div class="col-12 mb-2 col-md-7 d-flex justify-content-md-center align-items-center">
                    <div class="col-12 col-md-9 fs-32">
                        ...
                        <p class="fs-32">Je suis chef d'entreprise, et avec ma société JN HOLDING SAS, j'ai généré
                            plus de 2,5 millions d'euros en 3 ans.
            ...
            <div class="py-5 border-bottom"></div>
    ...
    <section>
        ...
        <div class="container-wb border-bottom"></div>
                                                        ...
                                                        <div class="mt-4">
                                                            ...
                                                            <ul class="fs-18 font-regular">
                                                                ...
                                                                <li>Audit complet de votre site si vous en avez ( valeur
                                                                    457€)</li>
                                                                <li>Plan d'action complet 30000€/100000€ en 90 jours selon
                                                                    votre niveau ( valeur 599€) </li>
                                                                <li>Maîtrise pointue des stratégies free trafic et paid
                                                                    trafic ( valeur 297€)</li>
                    ...
                    <div class="accordion" id="accordionExample">
                        <div class="accordion-item py-5 py-md-0 mb-2">
                            <h2 class="accordion-header" id="headingOne">
                                <button class="accordion-button font-bold fs-24 collapsed" type="button"
