        ...
        <div class="container-title d-flex justify-content-center align-items-center">
            ...
            <div class="col-12 col-md-6 text-center">
                <h1 class="wb-h2 wb-mb-5">La méthode simple en 3 étapes pour percer dans les business en
                    ligne</h1>
                <div class="mt-4">
                    <button class="btn rounded-pill btn-wb-primary d-block d-md-inline fs-18  px-2 px-md-3 w-wb-100">Démarrer maintenant</button>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 d-flex justify-content-center align-items-center">
                    <div class="col-12 col-md-10 fs-22">
                        <p class="fs-32 aos-init aos-animate mb-5" data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="100">Devenir financièrement indépendant avec les business en ligne,
                            c'est possible et j'en suis la preuve.</p>
                        <p class=" fs-32 aos-init aos-animate" data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="300">Je m'appelle Junior Natabou, et du haut de mes <span
            ...
            <div class="container-wb py-5 ">
                <div class="d-flex justify-content-center flex-column flex-md-row text-white">
                    <div class="col-12 wb-col-md-5  p-2 p-md-5 ">
                        <p class="fs-24 aos-init aos-animate" data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="100">Je sais que beaucoup de jeunes (toi aussi peut être) souhaitent s'inspirer
                    ...
                    <div class="col-12 wb-col-md-5  p-2 p-md-5">
                        <p class="fs-24 aos-init aos-animate" data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="300">C'est pourquoi, en me basant sur ma propre expérience et celle de nombreux
                            entrepreneurs qui ont réussi sur le web, j'ai élaboré cette  <strong class="font-bold">méthode en trois (03) étapes qui va
        ...
        <div class="container-fluid wb-py-8 wb-pb-88 bg-step-1 "  id="decouverte-step">
            <div class="container-wb py-5">
                <div class="row">
                    ...
                    <div class="col-12 mt-4 mt-md-0 mb-5 mb-md-0 col-md-4 d-flex justify-content-md-end align-items-md-center mb-3 order-1 order-md-2 aos-init aos-animate" data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="300">
        ...
        <div class="container-fluid wb-py-8 bg-step-2 "  id="formation-step">
            <div class="container-wb py-5">
                <div class="row">
                    ...
                    <div class="col-12 col-md-4  mb-5 mb-md-0 d-flex justify-content-md-end order-1 order-md-2 aos-init aos-animate" data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="300">
                        <div class=" container-img-ressource-methods">
                            <img src="{{ asset('img/hall.png') }}" alt="img-started-about" class="img-started-about">
        ...
        <div class="container-fluid bg-step-3 wb-py-8 wb-pb-step3" id="accompagnement-step">
            <div class="container-wb py-5">
                <div class="row">
                    ...
                    <div class="col-12 col-md-4 d-flex  mb-5 mb-md-0 justify-content-md-end order-1 order-md-2 aos-init aos-animate" data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="300">
                        <div class=" container-img-ressource-methods">
                            <img src="{{ asset('img/hall.png') }}" alt="img-started-about" class="img-started-about">
